...
Mas além disso, durante o jogo muitos personagens serão introduzidos.
Aqui está uma lista dos personagens da história.
\begin{itemize}
    \item Personagem principal (Personagem que será controlado pelo jogador);
